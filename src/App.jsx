  ...
  render() {
    if (this.state.error) {
      return (
        ...
        >
          <h2 style={{ color: "#F09595" }}>Что-то сломалось (ошибка ниже)</h2>
          <p style={{ fontSize: 13, opacity: 0.8 }}>
            Сфотографируй этот текст и отправь его — по нему можно будет починить баг.
          </p>
          <pre
            style={{
              fontSize: 15,
          ...
          <pre style={{ fontSize: 12, background: "#182238", padding: 12, borderRadius: 8, overflowX: "auto" }}>
            {String(this.state.error && this.state.error.stack)}
          </pre>
          {this.state.info && this.state.info.componentStack && (
            <pre style={{ fontSize: 11, background: "#182238", padding: 12, borderRadius: 8, overflowX: "auto", opacity: 0.7 }}>
