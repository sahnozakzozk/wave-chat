...
function CallActiveScreen({ callId, video, participants, username, displayName, t, userPhotos, onEnd }) {
  const [remoteStreams, setRemoteStreams] = useState({});
  ...
  useEffect(() => {
    ...
    const pollTargets = async () => {
      ...
      for (const target of targets) {
        ...
        if (!last) continue;
        const previewText =
          last.type === "sticker" ? last.text : last.type === "image" ? t.photoLabel : last.type === "call" ? callPreviewText(last, t) : last.text;
